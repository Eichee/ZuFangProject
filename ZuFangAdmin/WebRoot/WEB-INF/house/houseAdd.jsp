  ...
  <form action="" method="post" class="form form-horizontal" id="form-add">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-2">       	  
       	  <zf:select items="${regions }" name="regionId" txtName="name" valueName="id" id="regionId"/>
      </div>
      ...
      <div class="formControls col-2">
        <zf:select items="${roomTypes }" name="roomTypeId" txtName="name" valueName="id" id="roomTypeId"/>
      </div>  
    </div>
    <div class="row cl">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-2">
        <zf:select items="${status }" name="statusId" txtName="name" valueName="id" id="statusId"/>
      </div>
      ...
      <div class="formControls col-2">
        <zf:select items="${decoreteStatus }" name="decorateStatusId" txtName="name" valueName="id" id="decorateStatusId"/>
      </div>  
    </div>    
    <div class="row cl">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-10">
        <c:forEach items="${attachments }" var="att">
        	<zf:checkbox label="${att.name }" name="attachmentId" value="attchamentId-${att.id }"/>        	
        </c:forEach>
      </div>
    </div>               
    <div class="row cl">
