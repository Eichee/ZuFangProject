	...
	<table class="table table-border table-bordered table-hover table-bg">
		...
		<c:forEach items="${roles }" var="role">
			<tr class="text-c">
				...
				<td>${role.id }</td>
				<td>${role.name }</td>				
				<td class="f-14"><a title="编辑" href="javascript:;" onclick="admin_role_edit('角色编辑','<%=ctxPath %>/role?action=edit&roleId=${role.id }','1')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
