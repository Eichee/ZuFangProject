...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#kanbuq,#imgCaptcha").click(function(){
			$("#imgCaptcha").attr("src","<%=ctxPath%>/Index?action=captcha&rd="+Math.random());
		})
...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" id="data" method="post">
      <div class="row cl">
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          ...
          <img id="imgCaptcha" src="<%= ctxPath%>/Index?action=captcha"> <a id="kanbuq" href="javascript:;">看不清，换一张</a> </div>
      </div>
      <div class="row">
        <div class="formControls col-8 col-offset-3">
          <label for="online">
